<template>
    <header class="banner">
        ...
        <img src="../assets/images/foto-banner.png" alt="Foto de uma mulher morena de camisa laranja e está cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e apoiando um celulaar entre seu rosto e ombro." class="foto-banner">
    </header>
</template>
